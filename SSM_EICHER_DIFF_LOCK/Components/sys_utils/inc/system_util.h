 ...
 */
#define ADD_JSON_ELEMENT_U8(Name, DataType, Data) \
    {                                             \
 ...
 */
#define ADD_JSON_ELEMENT_U16(Name, DataType, Data) \
    {                                              \
        strcat(DataType, "\"" Name "\":\"");       \
 ...
 * @brief Format for adding U16 element in JSON
 */
#define ADD_JSON_ELEMENT_U32(Name, DataType, Data) \
    {                                              \
        strcat(DataType, "\"" Name "\":\"");       \
        sprintf(tmp, "%ld", Data);                 \
        strcat(DataType, tmp);                     \
 ...
 */
#define ADD_JSON_ELEMENT_FLOAT(Name, DataType, Data) \
    {                                                \
        strcat(DataType, "\"" Name "\":\"");         \
        sprintf(tmp, "%04.3f", Data);                \
        strcat(DataType, tmp);                       \
        strcat(DataType, "\"");                      \
    }

#define ADD_GPS_ELEMENT_FLOAT(Name, DataType, Data) \
    {                                               \
        strcat(DataType, "\"" Name "\":\"");        \
 ...
 */
#define ADD_STRING(Name, DataType, Data)     \
    {                                        \
        strcat(DataType, "\"" Name "\":\""); \
